...
-- -- 通用阅读书籍处理函数
-- -- **********************************************************************************
-- Phone.processReadBook = function(player, bookType)
...
-- -- 测试技能书
-- -- **********************************************************************************
-- Phone.testSkillBook = function(player)
-- 	Phone.processReadBook(player, "Base.BookCooking1");
-- end

-- -- **********************************************************************************
-- -- 测试配方书籍
-- -- **********************************************************************************
-- Phone.testRecipeBook = function(player)
-- 	Phone.processReadBook(player, "Base.HerbalistMag");
-- end

-- -- **********************************************************************************
-- -- 测试文艺书籍
-- -- **********************************************************************************
-- Phone.testLiteratureBook = function(player)
-- 	Phone.processReadBook(player, "Base.Book");
-- end

-- -- **********************************************************************************
-- -- 测试电子书
-- -- **********************************************************************************
-- Phone.testPhone = function(player)
-- 	Phone.processReadBook(player, "Base.Phone");
-- end

-- -- **********************************************************************************
-- -- 测试阅读书籍功能（保持原有功能）
-- -- **********************************************************************************
-- Phone.testReadBook = function(player)
-- 	Phone.processReadBook(player, "Base.BookCooking1");
-- end
...
-- -- 生成电子书物品
-- -- **********************************************************************************
-- Phone.generatePhone = function(player)
-- 	-- 直接添加手机物品到玩家背包
-- 	player:getInventory():AddItem("Base.Phone");
-- 	print("[Phone] 手机 added to inventory");
-- 	player:Say("手机 added to inventory");
-- end

-- -- **************************************************************************************
-- -- 填充世界对象上下文菜单
-- -- **************************************************************************************
-- Phone.doWorldContextMenu = function(playerNum, context, worldobjects)
-- 	local player = getSpecificPlayer(playerNum)
-- 	-- 检查玩家是否存活
-- 	if player:isAlive() then
-- 		-- 创建主菜单
-- 		local testMenu = context:addOption("手机 Test", nil, nil);
-- 		local subMenu = context:getNew(context);
-- 		context:addSubMenu(testMenu, subMenu);
		
-- 		-- 添加技能书测试选项
-- 		local skillBookOption = subMenu:addOption("Skill Book Test", nil, function()
-- 			Phone.testSkillBook(player);
-- 		end);
		
-- 		-- 添加配方书籍测试选项
-- 		local recipeBookOption = subMenu:addOption("Recipe Book Test", nil, function()
-- 			Phone.testRecipeBook(player);
-- 		end);
		
-- 		-- 添加文艺书籍测试选项
-- 		local literatureBookOption = subMenu:addOption("Literature Book Test", nil, function()
-- 			Phone.testLiteratureBook(player);
-- 		end);
		
-- 		-- 添加手机生成选项
-- 		local generatePhoneOption = subMenu:addOption("Generate 手机", nil, function()
-- 			Phone.generatePhone(player);
-- 		end);
-- 	end
-- end
...
-- -- **************************************************************************************
-- Phone.init = function()
-- 	Events.OnFillWorldObjectContextMenu.Add(Phone.doWorldContextMenu);
-- end

-- -- **************************************************************************************
-- -- 注册事件
-- -- **************************************************************************************
-- Events.OnGameStart.Add(Phone.init)
